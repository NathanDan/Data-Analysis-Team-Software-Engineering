...
df19 = pd.read_csv('Madrid 2019.csv', parse_dates=['Month'], index_col="Month")  #CREATING THE 2019 DATA-FRAME THAT WILL STORE ALL DATA FOR THE 2019 GRAPH

df20 = pd.read_csv('Madrid 2020.csv', parse_dates=['Month'], index_col="Month")  #CREATING THE 2020 DATA-FRAME THAT WILL STORE ALL DATA FOR THE 2020 GRAPH
...
df20.plot(color='#3498db', title='Difference In NO2 Levels In 2019 And 2020 - Madrid',ax=ax) #CREATING THE 2019 AND 2020 GRAPH WITH THE 2019 GRAPH ON THE SAME AXIS
